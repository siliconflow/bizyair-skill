...
| 核心能力 | 覆盖场景 | 交互特性 |
| :--- | :--- | :--- |
| **图片生成** | 文生图、图生图、图片编辑、扩图 | **5个常用入口** + 站内搜索 |
| **视频生成** | 文生视频、图生视频、对口型等 | **5个常用入口** + 站内搜索 |
| **AI 应用与 Modelzoo** | 解析并运行各类 BizyAir 应用 | 支持链接直达、信息解析、站内搜寻 |
...
### 4. 站内搜索推荐
如果你不知道该用哪个工具，或者觉得默认菜单里的不够贴切，直接用自然语言告诉他！**助手会根据你的自然语言需求，直接去 BizyAir 站内帮你找出最对口的应用候选。**

比如，你可以说：
> "我想生成个建筑的效果图，你看看bizyair上有啥合适的吗？"
